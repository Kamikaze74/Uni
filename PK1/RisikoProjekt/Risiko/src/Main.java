public class Main {
    public static void main(String[] args) {
        ...
        Risiko ar1 = new AkzeptablesRisiko("Lizenzkosten steigen", 0.4f, 2000f);
        Risiko ar2 = new AkzeptablesRisiko("Cloud-Kosten", 0.5f, 1800f);
        Risiko ar3 = new AkzeptablesRisiko("Server-Ausfall", 0.7f, 2200f);

        Risiko er1 = new ExtremesRisiko("Cyberangriff", 0.1f, 100000f, "die masname", 5000.0f);
        Risiko er2 = new ExtremesRisiko("Hochwasser", 0.3f, 150000f, "gebäudeversicherung", 8000.0f);
